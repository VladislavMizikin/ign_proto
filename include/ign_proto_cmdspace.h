...
/**
 * @defgroup IGN_CMD_APP_TEST_CAPTURE Команды накопления результатов тестов
 * @brief Команды универсального RAM-накопителя самоописываемых результатов тестов.
 *
 * Используются для запуска одного диагностического или отладочного теста,
 * накопления бинарных записей в основной программе и последующего постраничного
 * чтения схемы и результата сервисным приложением.
 * @{
 */
#define IGN_CMD_TEST_CAPTURE_LIST          0x70u  ///< Получить страницу списка тестов накопителя
#define IGN_CMD_TEST_CAPTURE_SCHEMA        0x71u  ///< Получить страницу самоописываемой схемы результата
#define IGN_CMD_TEST_CAPTURE_START         0x72u  ///< Запустить выбранный тест накопителя
#define IGN_CMD_TEST_CAPTURE_STOP          0x73u  ///< Остановить активный тест накопителя
#define IGN_CMD_TEST_CAPTURE_STATUS        0x74u  ///< Получить состояние активного или последнего теста
#define IGN_CMD_TEST_CAPTURE_RESULT_INFO   0x75u  ///< Получить сведения о накопленном результате
#define IGN_CMD_TEST_CAPTURE_RESULT_READ   0x76u  ///< Получить страницу бинарных записей результата
#define IGN_CMD_TEST_CAPTURE_RESULT_CLEAR  0x77u  ///< Очистить результат и вернуть накопитель в исходное состояние
/** @} */
